...
MESSAGETEXT
  ...
  def getExplosionSpecialConsumptionResultTables
    ...
    tables = [[
      [0, '……하지만 아무 일도 일어나지 않았다!: 효과 없음'],
      [1, '당신의 머리카락이 폭발했다! 멋진 아프로 헤어다: 시나리오가 끝날 때까지 [머리] 태그를 가진 장비는 장비 불가'],
      [2, '예술은 폭발이다: 소지하고 있는 아이템 중 랜덤으로 정한 하나가 예술품이 되어 [환전] 아이템이 된다.'],
      [3, '반응 기폭 장갑: 방어구 슬롯에 장비하고 있는 아이템이 쵸밤 아머가 된다. 다음에 당신이 【HP】 대미지를 받았을 때, 그 대미지를 무효로 하고 이 아이템을 잃는다.'],
      [4, '산양 슬라임이 폭발적으로 증식한다: [소지품] 슬롯을 모두 산양 슬라임([거래 불가], 가격50)으로 채운다.'],
      [5, '당신의 리얼이 폭발한다: 커넥션 하나를 시나리오가 끝날 때까지 잃는다.'],
      [6, '공장이 폭발한다: [소모품] 태그를 가진 아이템을 구입할 수 없게 된다.'],
      [7, '보스 에너미가 폭발한다: 시나리오는 클라이맥스를 맞이하지 않고 종료된다. 수고하셨습니다.'],
    ]]
    return tableName, tables
  end
  ...
  def getCurseSpecialConsumptionResultTables
    ...
    tables = [[
      [0, '「축복해주지!」 축복을 받는다: 당신의 【인과력】+1'],
      [1, '공복의 저주: 즉시 식량 아이템 하나를 먹는다. 배가 고프니 엄청 맛있어!'],
      [2, '무직의 저주: 서브 직업이 강제로〈니트〉로 변경된다.'],
      [3, '종족 변경의 저주: 랜덤으로 다이스를 굴려 다른 종족으로 변한다. 종족특기를 사용할 수 없게 된다.'],
      [4, '배리어 프리의 저주: [경감], [장벽]상태가 될 수 없게 된다.'],
      [5, '집중력을 흐트리는 속삭임의 저주:자세가 무너져 [태세] 태그를 가진 특기를 사용할 수 없게 된다.'],
      [6, '맹목의 저주: 당신이 소지한 커넥션 중 랜덤으로 선택한 관계 하나가 「열애」로 변한다.'],
      [7, '의욕이 사라지는 저주: 아~ 진짜 의욕이 안 나네. 아무 것도 하기 싫어.【인과력】 사용 불가.'],
    ]]
    return tableName, tables
  end
  ...
  def getMagicTresureResultTable
    ...
    table = [
      ...
      [10, '마촉매1[마촉매1](15G)x3'],
      [11, '마촉매1[마촉매1](15G)x3'],
      [12, '코발트조각[코어소재](30G)&광석 샘플[환전](15G)'],
      [13, '신록의 떡잎[코어소재](30G)&조그만 꽃씨[환전](20G)'],
      [14, '생명의 잎[코어소재](40G)&강인한 넝쿨[환전](10G)'],
      [15, '날카로운 송곳니[코어소재](40G)&잘 길든 나이프[환전](10G)'],
      [16, '마촉매3[마촉매3](25G)x2'],
      [17, '오래된 해골[코어소재](40G)&검은 시집[환전](15G)'],
      [18, '흑수련꽃잎[코어소재](40G)&물곰방대[환전](20G)'],
      [19, '순백색깃털[코어소재](40G)&조그만 고글[환전](20G)'],
      [20, '진홍색 발톱[코어소재](50G)&조그만 거울[환전](15G)'],
      [21, '적열의 작은 발톱[코어소재](50G)&세공 화로[환전](20G)'],
      [22, '자성의 작은덩쿨[코어소재](50G)&그을린 용가죽[환전](20G)'],
      [23, '유성 조각[코어소재](50G)&소박한 반지[환전](10G)x2'],
      [24, '성스러운 섬유[코어소재](50G)&흠짓 난 메달[환전](25G)'],
      [25, '부러진 축[코어소재](60G)&잡동산이 무더기[환전](5G)x4'],
      [26, '거인의 머리카락[코어소재](50G)&조그만 빗[환전](20G)'],
      [27, '정밀한 톱니바퀴[코어소재](60G)&공구강 파편[환전](25G)'],
      [28, '뾰족한 발톱[코어소재](60G)&자수 장식띠[환전](30G)'],
      [29, '촉매 플라스크[코어소재](60G)&작은 초상화[환전](30G)'],
      [30, '액화마정[코어소재](60G)&정밀한 인형[환전](35G)'],
      [31, '마촉매5[코어소재](40G)&마촉매4[마촉매4](30G)x2'],
      [32, '부드러운 돌[코어소재](80G)&소형증류기[환전](20G)'],
      [33, '수수께끼의 모피[코어소재](80G)&기묘한 두개골[환전](30G)'],
      [34, '별똥별 은사[코어소재](80G)&주석 도금 별자리판[환전](30G)'],
      [35, '마촉매5[마촉매5](40G)x3'],
      [36, '소형연성진[코어소재](100G)&기괴한 오브제[환전](20G)'],
      [37, '마촉매6[마촉매6](50G)&마촉매5[마촉매5](40G)x2'],
      [38, '주문의 씨앗[코어소재](100G)&부서진 보석[환전](30G)'],
      [39, '은제원반[코어소재](100G)&순백색 코사주[환전](30G)'],
      [40, '잠자는 씨앗[코어소재](100G)&정원사의 장식끈[환전](40G)'],
      [41, '물엿색 점액[코어소재](1210G)&극채색 입자[환전](5G)x5'],
      [42, '마촉매6[마촉매6](50G)x3'],
      [43, '납색갑각[코어소재](120G)&향긋한 꽃봉오리[환전](10G)x4'],
      [44, '마촉매7[마촉매7](60G)&마촉매6[마촉매6](50G)x2'],
      [45, '커다란 마력결정[코어소재](120G)&요정의 낙서[환전](40G)'],
      [46, '권사의 백(魄)조각[코어소재](140G)&백지 두루마리[환전](40G)'],
      [47, '마촉매7[마촉매7](60G)x3'],
      [48, '푸른광석[코어소재](140G)&천연 유리덩어리[환전](25G)x2'],
      [49, '거대한 날개깃[코어소재](140G)&두꺼운 알껍질[환전](50G)'],
      [50, '마촉매8[마촉매8](70G)x2&마촉매7[마촉매7](60G)'],
      [51, '끊임 없는 불씨[코어소재](180G)&漆黒のスス[환전](20G)'],
      [52, '마촉매8[마촉매8](70G)x3'],
      [53, '마도 정제[코어소재](180G)&つくりかけの錠前[환전](10G)x3'],
      [54, '일곱색깔 투명나사[코어소재](180G)&열리지 않는 세공상자[환전](40G)'],
      [55, '편속성 마법결정[코어소재](220G)&보고서 다발[환전](10G)'],
      [56, '마촉매9[마촉매9](90G)&마촉매8[마촉매8](70G)x2'],
      [57, '마촉매9[마촉매9](90G)&마촉매8[마촉매8](70G)x2'],
      [58, '화려한 깃털장식[코어소재](220G)&공상동물 도감[환전](30G)'],
      [59, '모래장미[코어소재](220G)&바늘 같은 수정[환전](10G)x5'],
      [60, '마촉매9[마촉매9](90G)x3'],
  ...
  def getItemTresureResultTable
    ...
    table = [
      ...
      [20, '조그만 보석상자[환전](70G)'],
      [21, '놋쇠 촛대[환전](70G)'],
      [22, '귀족의 오래된 일기[환전](70G)'],
      [23, '기사의 초상화[환전](80G)'],
      [24, '옷칠 나막신[환전](80G)'],
      [25, '정밀한 게임 보드[환전](80G)'],
      [26, '정밀한 정물화[환전](90G)'],
      [27, '떡갈나무 의자[환전](90G)'],
      [28, '오래된 비스크 돌(러시아인형)[환전](90G)'],
      [29, '현란한 가면[환전](100G)'],
      [30, '토끼 봉제인형[환전](100G)'],
      [31, '놋쇠 몬스터상[환전](100G)'],
      [32, '지방 역사서[환전](110G)'],
      ...
      [44, '매 박제[환전](170G)'],
      [45, '대리석 현자상[환전](170G)'],
      [46, '자수가 들어간 쿠션[환전](180G)'],
      [47, '개 변장 탈[환전](180G)'],
      [48, '대형 떡갈나무 테이블[환전](190G)'],
      [49, '조각 반지[환전](190G)'],
      [50, '화조화 족자[환전](200G)'],
      [51, '최상급 모피[환전](210G)'],
      [52, '질 좋은 백분[환전](210G)'],
  ...
  def getHeroineTresureResultTable
    ...
    table = [
      ...
      [41, '사소한 것에 바로 얽메이게 되는 금발소녀'],
      [42, '함께 돌아가는 것을 부끄럽게 생각하는 핑크머리 소꿉친구'],
      [43, '배가 안좋아서 화장실에 상주하게 되는 엘프소녀'],
      [44, '응시하면 얼굴이 빨개지는 앞머리 법의족 소녀'],
      [45, '바로 파밧하고 겁먹는 소동물계 소녀'],
      [46, '키가 크고 신사적인 여성 극단의 왕자님역의 기사녀'],
      [47, '올곧은 성격의 근육이 있는 드워프 여자'],
      [48, '항상 꿈에서 당신을 보는 포니테일의 소녀'],
      [49, '선진선구, 심야에서 새벽까지 달리는 잠꾸러기 언니인 사무라이'],
  ...
  def getEastalDiceCommandResult(command)
    ...
    table = ["숲 베리 따기: 여러분은 베리가 열린 수풀을 발견한다. 탐색을 하는 PC는 난이도 8의 [지각판정]을 한다(한 명당 1회만). 성공한 사람은 「숲 베리 (맘대로 샌드위치에 상당)」를 하나 입수한다.",
             ...
             "페어 트레이드: 여러분은 〈대지인〉 농부를 만났다. 20G를 내면 「계절야채 포토푀」를 구입할 수 있다(다 합쳐서 PC와 같은 수까지).",
             "강에서의 삶: 제방을 따라 강 근처를 걷는다. 작은 선착장에서 위세 좋은 목소리가 들린다. 물고기를 잡고 있는 모양이다.",
             "건너려 해도 건널 수 없는: 강물이 붇는 바람에 여러분은 강을 건널 곳을 찾느라 고생한다. [수생] 태그를 소지하고 있거나 얻을 수 있는 수단이 있는 PC가 한 명이라도 있다면 아무 문제 없다. 없다면 멀리 우회하여 전원 [피로: 10]을 입는다.",
             "코볼트 조우전: 여러분은 코볼트 무리를 물리쳤다! 전원 10G를 손에 넣는다. 쫓아가서 섬멸한다면 전원 [피로: 10]을 입는 대신 추가로 「코볼트의 이빨 [환전](10G)」를 한 사람당 1개 손에 넣는다.",
             "풍요로운 전원 풍경: 큰 논이 몇 자리나 펼쳐져 있다. 가을이라면 황금색 벼 이삭이 바람에 흔들릴 것이다.",
             "불운한 예감: 검은 고양이가 눈앞을 가로지르고, 까마귀가 머리 위에서 울고, 신발 끈이 뚝 끊어졌다. 왠지 모를 한기까지. 여러분 전원은 【인과력】을 1점 잃는다.",
             "친구의 친구는 친구: PC 전원은 2D를 굴린다. 가장 큰 눈이 나온 「당신」은 가장 적은 눈이 나온 「대상」과 공통의 지인에 대한 화제로 이야기꽃을 피운다. 당신과 대상은 「인과력 티켓」 한 장으로 각자 서로에 대한 커넥션을 취할 수 있다. 관계는「우정, 이해」 중 하나가 된다.",
             "시간은 흐른다: 길을 따라 외벽만 남은 철근 빌딩이 서 있다. 지금은 새의 둥지가 된 듯하다.",
             "갑작스러운 폭우!: 여러분은 갑작스러운 폭우를 만나, 고생 끝에 폐가에 도착했다. 여러분 전원은 [식량] 아이템을 하나 소비해야 한다. 단, [피로] 회복량은 절반이다. [식량] 아이템을 소비할 수 없는 경우는【인과력】 1점을 잃는다.",
             "들꽃이 만발하다: 여러분은 넓은 꽃밭에 도착한다. 탐색을 하는 PC는 목표치 9의 [지식판정을 한다(한 명당 1회만). 성공한 사람은 「귀중한 약초 [환전] (20G)」를 하나 입수한다.",
             "녹색 터널: 멋진 할엽수가 나란히 늘어서서 녹색의 천장을 이루고 있다. 발치에는 부엽토가 두껍게 깔렸고, 곳곳에서 나무뿌리가 모습을 드러내고 있다.",
             "고블린 강습 부대: 여러분은 고블린 강습부대와의 조우전에 휘말렸다. 여러분 전원은 [피로: 20]을 입거나, 또는 [시나리오n회]형 특기의 사용횟수를 소비한다(여러분이 선택).",
             "정보교환: 여러분은 모험자 집단과 만났다. 대표자는 목표 10의 [교섭판정]을 한다(적절한 서브 직업이 있다면 +2의 보너스를 얻을 수도 있다). 성공하면 부근의 정보를 들을 수 있다. 여러분 중 하나는 다음에 하는 [정찰] 행동에 +2를 얻는다.",
             "못의 어부: 물이 가득한 못에 나왔다. 어부가 투망을 던지는 모습이 보인다.",
             "토막난 샛길: 산사태로 길이 무너져 내리고 말았다. 이 길은 사용할 수 없을 것 같다. [비행] 상태이거나 [비행] 상태를 얻을 수 있는 수단을 가진 PC가 한 명이라도 있다면 주변을 탐색할 수 있으므로 문제는 없다. 그렇지 않다면 여러분은 아주 멀리 돌아가야 한다. 여러분 전원은 [피로:25]를 입는다.",
             "코볼트를 물리쳐라!: 여러분은 코볼트 순찰대를 물리쳤다. 전원 [피로: (1D6+5)]를 입는 대신, 전리품으로 1인당 20G를 입수한다.",
             "대지의 은총: 이랑을 따라 채소의 파릇파릇한 잎이 무성하다. 맛있는 요리를 만들 수 있을 것 같다.",
             "미끄러져 굴러서: 가도를 걷고 있는데 갑자기 거대한 와일드 보어가 튀어나온다. 피하던 찰나에 넘어져서 여러분 전원은 [소모품] 아이템을 하나 잃는다. [소모품]아이템을 가지고 있지 않다면 【인과력】 1점을 잃는다.",
             "빙글빙글 꽈당: PC 전원은 2D를 굴린다. 가장 작은 눈의 「당신」은 젖은 풀에 발이 미끄러져 굴러떨어지고 만다. 구해준 동료는 「인과력 티켓」 한 장으로 「당신」에 대해 커넥션을 얻을 수 있다. 관계는 「비호, 친애」 중 하나가 된다.",
             "무인들이 꾼 꿈의 흔적: 반쯤 무너진 돌담이 이어진다. 아인과의 격렬한 싸움의 흔적도 지금은 희미하게 남아있을 뿐이다.",
             "오리무중: 짙은 안개가 낀다. 팔을 뻗으면 손끝이 안 보일 정도다. 여러분 전원은 [피로: 25]를 입거나 【인과력】 1점을 잃는다(여러분이 선택).",
             "치유의 샘물: 여러분은 세차게 솟구치는 맑은 물을 발견한다. 목표치 13의 [지각판정]을 한다. 누구든 한 명이라도 성공하면 이것이 매우 맑으며 마력이 있는 물이라는 것을 알게 된다. 길어 담아갈 수는 없지만, 마시면 즉석에서 【인과력】 1점을 얻는다.",
             "침엽수 숲: 침엽수가 울퉁불퉁한 나무껍질을 드러내고 있다. 그늘에 잡초가 적어 조금 쌀쌀한 인상을 받는다.",
             "어인의 습격: 여러분은 사하긴 순찰소대와 격렬한 싸움을 벌였다! 여러분 전원은 [피로: 25]를 입거나 [소모품] 아이템 2개를 잃는다(여러분이 선택).",
             "상부상조: 여러분은 꼼짝도 못 하고 서 있는 마차에 탄 여행자를 만났다. 그들을 돕는 경우, 도우려는 멤버 전원이 [조작판정]을 한다. 달성치 합계가 (PC 수ⅹ10)이상이라면 마차를 길에 되돌린다. 그 경우 1인당 20G의 사례금을 받는다.",
             "시냇물과 산들바람: 잔잔하게 흐르는 작은 시냇가로 나왔다. 수면을 스쳐 지나가는 산들바람에 기분이 상쾌하다.",
             "파이팅 일발!: 여러분은 절벽을 따라 난 좁은 통로를 나아가느라 체력만이 아니라 기력까지 소모한다. 여러분 전원은 [피로:15]를 입는다. 거기에 더하여 [피로: 15]를 입거나 【인과력】 1점을 잃는다(여러분이 선택).",
             "거인과 만나다: 숲 위로 불쑥 머리를 내민 것은 대머리 거인이었다. 전투에 승리한 여러분은 전원 25G를 입수한다. 거인의 보금자리를 찾으려면 대표자가 목표치 12의 [해석판정]에 성공해야 한다. 성공한 경우 거인의 보금자리에서 [마촉매6]을 1D6+1개 입수한다.",
             "휴식 장소: 쉬기 딱 좋은 도로 가의 공터를 발견한다. 예전에 누군가 같은 생각을 한 사람이 있었는지 모닥불을 피운 흔적도 있다.",
             "그럴 리가: 길을 잃고 말았다. 여러분 전원은 【인과력】을 2점 잃는다. 【인과력】을 잃을 수 없는 경우, 부족한 【인과력】 1점당 [피로: 15]를 입는다. 여러분의 동료중에 [지도 제작자]나 [척후]가 있다면 [피로: 15]는 [피로: 10]으로 그친다.",
             "좋아하는 애 있어?: 무슨 영문인지 여러분은 휴식 중에 좋아하는 이성에 대한 화제에 돌입하고 말았다. [애정] 또는 [사랑], [설렘]에 준하는 커넥션을 가지고 있는 PC는 그 사실을 고백할 수 있다. 그 경우, GM은 그 PC의 용기에 깊이 감동하며【인과력】 1점을 주자. 만약 고백 상대가 지금 파티에 있는 동료라면, 롤플레이에 따라서는 그 상대에게도 준다.",
             "저 다리를 건너서: 붉게 녹슨 철교가 강 위로 그림자를 드리우고 있다. 예전에는 전차가 이 다리 위를 건넜는지 이끼 사이로 레일이 엿보인다.",
             "얼음덩어리: 큼직한 우박이 내려 사정없이 여러분을 두들긴다. 주위는 탁 트인 토지라서 피할 수도 없다. 여러분 전원은 [피로: 30]을 입는다.",
             "두근두근 동굴: 여러분은 기분 나쁜 동굴을 발견한다. 탐색을 하는 PC는 목표치 12의 [지각판정]을 한다. 실패한 사람은 [피로: 10]을 입는다. 한 사람이라도 성공한 경우, 동굴 안에서 금화 100G가 들어있는 자루를 발견한다. 공평하게 나누자!",
             "수풀을 헤치고: 낮은 관목이 곳곳에 수풀을 이루고 있어 똑바로 전진하기 힘들다.하지만 누군가가 지나간 길이 있어서 헤매지 않고 끝날 것 같다.",
             "이곳에서 저지하라!: 여러분은 〈대지인〉의 마을 주변에서 와이번과의 전투에 돌입했다! 여러분 전원은 [피로: 30]을 입거나 【인과력】 2점을 잃는다(여러분이 선택).",
             "언젠가 지나온 길: 여러분은 아직 신출내기인 〈모험자〉들과 만났다. 뭔가 도움을 주고 싶다면 [소모품]을 몇 개쯤 건네줄 수도 있고, 뭐든 조언을 해줄 수도 있다. 그들은 거듭 감사하며 길을 떠난다. GM은 PC들의 롤플레이에 따라 【인과력】 1점을 줄 수 있다.",
             "계곡에 울리는 물소리: 가파른 골짜기 밑에서 기세 좋게 물이 흐른다. 그리 멀지않은 곳에서 폭포 소리가 들려온다.",
             "독 늪: 여러분은 썩은 내가 풍기는 늪지를 가로질렀다. 여러분 전원은 목표치 14의 [운동판정]을 해야 한다. 실패한 PC는 [소모품] 아이템을 2개 잃는다.",
             "고르곤 슬레이어: 여러분은 쇠로 된 피부	를 지닌 소를 물리쳤다! 전원 【인과력】 1점을 잃는다. 전리품으로 【철우의 비늘 [환전] (35G)】를 인원수만큼 손에 넣는다.",
             "개척자들: 몇 명의 대지인이 숲을 개간하고 있다. 씨를 뿌리려면 조금 더 걸릴 것 같다.",
             "예상 밖의 조우: 10m가 넘는 녹색 드래곤과 우연히 마주친다. 왜 이런 곳에! 여러분은 전력을 다해 도망쳤다. 여러분 전원은 【인과력】을 2점 잃거나, [보조장비] 하나에 [파손] 태그를 입는다. 둘 다 할 수 없다면 [피로: 35]를 입는다.",
             "끝말잇기는 귀문: 여러분은 여행의 흥을 돋우기 위해 다 함께 끝말잇기를 하면서 걷고 있다. PC 전원은 「누」(GM은 다른걸로 바꿔도 좋다)로 시작하는 단어를 하나 발표한다. 가장 창피한 단어를 발표한 PC를 다 함께 결정한다. 그 PC에 대한 커넥션을 가지고 있는 다른 PC는 커넥션의 관계를 [동정], [실망], [재미있음]으로 변경할 수 있다.",
             "오래된 신역: 커다란 석제 토리이가 오랜세월의 풍파를 견디며 우뚝 솟아있다. 주위에 엄숙한 분위기가 가득했다.",
             "난기류: 돌풍은 회오리가 되었다! 여러분은 간신히 통과할 수 있었지만 멀쩡하지는 않았다. 여러분은 [피로: 35]를 입거나 [소모품] 2개를 잃는다(여러분이 선택).",
             "노리려면 월척을: 여러분은 멋진 낚시터를 발견한다. 탐색을 하는 PC는 [식량] 아이템을 하나 소비해서 목표치 13의 [조작판정]을 한다(어부나 그에 준하는 서브 직업에겐 +2를 줘도 좋다). 성공한 사람은「기름이 오른 송어 (정석 카레에 상당)」를 [1D/2]마리(최저 1마리) 입수한다.",
             "고목 미궁: 울퉁불퉁한 고목이 서로 얽혀 압박감을 느끼게 한다. 숲이 보내온 세월의 무게가 어깨를 짓누르는 듯하다.",
             "중과부적: 여러분은 무수한 구렁이에게 둘러싸였다! 여러분 전원은 [피로: 40]을 입거나 보조장비 하나에 [파손] 태그를 붙인다(여러분이 선택).",
             "축복의 고리: 여러분은 대지인의 마을에서 결혼을 축하하는 조촐한 연회를 접한다. 축복을 해주고 싶다면 대표 PC가 난이도 14의 [교섭] 판정을 한다. 선물로 [식량] 태그를 가진 아이템을 하나 내놓을 때마다 +2의 보너스를 얻는다. 성공한 경우, 어딘가에서 상쾌한 바람이 불어 여러분 전원은 【인과력】 1점을 얻는다. 그렇지 않은 경우라도 연회에는 초대받으며, 소박한 만찬을 먹고 전원의 [피로]가 -20 줄어든다.",
             "큰 강을 이루는 한 방울: 깨끗한 물이 세차게 솟아난다. 이 물은 분명 저 큰 강으로 이어질 것이다.",
