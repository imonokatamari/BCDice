...
MESSAGETEXT
  ...
  def getFrindDateTable()
    ...
    table = [
      ...
      [25, "「一緒に遊ぼうよ！」\n一緒に一つのゲームに向かい合って遊んでみる。お互いに2Ｄ6を振る。攻め気キャラの出目が高かった場合、攻め気キャラの受け身キャラに対する《感情値》1点上昇する。受け身キャラの出目が高かった場合、受け身キャラの攻め気キャラに対する《感情値》が2点上昇し、属性は《好意》となる。"],
  ...
  def getOnewayDateTable()
    ...
    table = [
      ...
      [13, "「お仕置き、しないとね。」\n受け身キャラが持っている一番高い《好意》を持っているキャラクターを選ぶ。選ばれたキャラクターは《生命力》を1Ｄ6点減少し、攻め気キャラに対する感情の属性が《敵意》になる。選んだキャラクターが攻め気キャラだった場合、攻め気キャラの受け身キャラに対する《感情値》が1点上昇し《生命力》が1Ｄ6天回復する。"],
      ...
      [55, "「肩、揉んであげようか？」\n疲れを察して、率先して動いて休ませてあげる。受け身キャラは《生命力》が1Ｄ6点回復し、攻め気キャラに対する《感情値》の属性が《好意》になる。"],
  ...
  def getMidnightDateTable()
    ...
    table = [
      ...
      [23, "「夜の学校っていいもんだな。」\n夜の学園に忍び込み、二人で探検する。攻め気キャラは1Ｄ6を振る。出た目と同じだけ、お互いに対する《感情値》が上昇し、属性が反転する。"],
      ...
      [26, "「綺麗な星だな。」\n空を見上げて二人で天体観測。二人の距離はずっと近くに。この表の使用者がお互いに対する《好意》を持っている場合、お互いに対する感情値が1Ｄ6点上昇する。"],
      [33, "「眼が冴えてきたな。」\n目が冴えてきて、夜中でも問題なく動けそうだ。この表の使用者は、このパートの間「真夜中パートに睡眠を行わなかったキャラクターは、そのパート終了時に1Ｄ6点を振って、その目に対応した変調を受けます。」というルールを無効化し、「真夜中デート表」をもう一度振る。"],
      [34, "「夜の騎士！」\n夜に紛れて悪さをしようとしていた悪人を懲らしめて戦利品を手に入れる。攻め気キャラは好きな能力値で判定を行う。成功すると、受け身キャラの攻め気キャラに対する《感情値》が判定の成功度だけ上昇する。攻め気キャラは【タバコ】か【お金】を手に入れる。"],
      [35, "「いいものアルヨ。」\n妖しいポーションの勧誘に引っかかってしまった。攻め気キャラは[政治力]で判定を行う。判定に成功すると、受け身キャラは《生命力》を1Ｄ6点回復し、《感情値》が回復した《生命力》の値と同じだけ上昇し、属性が《好意》になる。判定に失敗すると、受け身キャラは「病気」の変調を受け、《感情値》が2点上昇する。"],
      ...
      [46, "「月以外、誰も見ていないさ……。」\n見つめ合ったまま、二人の夜が更けていく。この表の使用者はお互いの《感情値》が1Ｄ6点上昇し、属性は好きなものを選ぶことができる。"],
...
TABLE_TEXT_END
      ...
      'JH' => {
        ...
        :type => '2d6',
        :table => <<'TABLE_TEXT_END'
授業中に突然テロリストが侵入してくる。「日常遭遇表（ｐ97）」を使ってエネミーを決定する。そのエネミーと、この授業判定を行ったキャラクターは戦闘を行う。
